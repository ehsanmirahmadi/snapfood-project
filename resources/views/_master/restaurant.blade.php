        ...
        @auth
            ...
            >
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="nav-item">
                        <a href="{{route("dashboard.res")}}" class="nav-link {{$path == 'dashboard-res' ? "active" : "link-body-emphasis"}}">
                            Home
                        </a>
                    </li>
                    <li>
                        <a href="{{route("dashboard.res.menu" , ['slug' => auth()->user()['slug']])}}" class="nav-link {{$path == \Illuminate\Support\Facades\Request::routeIs('dashboard.res.menu') ? "active" : "link-body-emphasis"}}">
                            Menu
                        </a>
                    </li>
                    <li>
                        <a href="{{route('dashboard.res.order')}}" class="nav-link {{$path == Illuminate\Support\Facades\Request::routeIs('dashboard.res.order') ? "active" : "link-body-emphasis"}}">
                            Order
                        </a>
                    </li>
